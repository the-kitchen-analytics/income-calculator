...
public class WorkerCategoryQueryFilter
  ...
  public List<ProcedureView> filter(ProceduresQueryParams params) {
    return service.findAllByWorkerCategory(params.workerCategory().orElseThrow());
  }

  @Override
  public boolean isApplicable(ProceduresQueryParams params) {
    return params.workerCategory().isPresent() && params.type().isEmpty();
  }
}
